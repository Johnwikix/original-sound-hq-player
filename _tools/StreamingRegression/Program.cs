...
try
{
    ...
    await client.PrepareAsync(source with { Location = server.Url("slow") }, firstPending);
    await client.PrepareAsync(source with { Location = server.Url("slow") }, secondPending);
    ...
    if (args.Contains("--play"))
    {
        ...
        await client.PrepareAsync(source, audible);
    ...
    await client.PrepareAsync(source with { Location = server.Url("slow") }, Guid.NewGuid());
    alive.Dispose();
