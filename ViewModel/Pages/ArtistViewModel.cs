...
namespace WinUIMusicPlayer.ViewModel
{
    public partial class ArtistViewModel : ObservableObject
    {
        ...
        public void UpDateUsbDeviceMenuflyout()
            => ToolUtils.UpdateUsbSendMenu(ArtistMenuOptions, TransmitFileToUsbCommand);
        ...
        private async Task Play()
        {
            ...
            try
            {
                ...
                slice.Sort((a, b) => CjkStringComparer.Compare(a.Album, b.Album));
        ...
        private void AddToFavour()
        {
            var artists = AppViewModel.SongsSource.AsValueEnumerable()
                ...
                .OrderBy(m => m.Album, CjkStringComparer.Instance);
