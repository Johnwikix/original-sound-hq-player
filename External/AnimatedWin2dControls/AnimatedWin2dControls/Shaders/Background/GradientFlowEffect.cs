...
{
    /// <summary>
    /// 移植自 <see href="https://github.com/ghost1372/DevWinUI/blob/main/dev/DevWinUI.Shader/Shaders/GradientFlowShader.cs"/>
    /// (原作出处 <see href="https://www.shadertoy.com/view/wdyczG"/>)。
    /// 原签名 4 个 float3 颜色参数改名归一 (colorA..D → color1..4)，其他逻辑零变化。
    /// </summary>
    [D2DInputCount(0)]
    [D2DShaderProfile(D2D1ShaderProfile.PixelShader50)]
    [D2DGeneratedPixelShaderDescriptor]
    [D2DRequiresScenePosition]
    public readonly partial struct GradientFlowEffect(
        float time,
        float2 dispatchSize,
        float3 color1,
        float3 color2,
        ...
        float3 color4) : ID2D1PixelShader
    {
        ...
        public float4 Execute()
        {
            ...
            float3 layer1 = Hlsl.Lerp(color1, color2, layer1Mask);
            float3 layer2 = Hlsl.Lerp(color3, color4, layer2Mask);
