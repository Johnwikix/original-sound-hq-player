...
namespace WinUIMusicPlayer.Services
{
    public class MusicDatabaseService
    {
        ...
        public async Task GetSettingsAsync()
        {
            ...
            {
                _appObservableObj.DefaultEntryComboBoxTag = settings.DefualtEntry;
                _appObservableObj.DefaultPlayListComboBoxTag = settings.DefualtPlayList;
                AppSettings.OutputMode = settings.OutputMode;
                _appObservableObj.Latency = settings.Latency;
                ...
                _appObservableObj.BackdropType = settings.AppStyle;
                _appObservableObj.ThemeType = settings.AppTheme;
                _appObservableObj.IsCoverCacheEnabled = settings.isCoverCacheEnabled;
                AppSettings.isRunningBackend = settings.isRunningBackend;
                _appObservableObj.IsAutoLyricsEnabled = settings.isAutoLyricsEnabled;
                _appObservableObj.DsdGain = settings.dsdGain;
                _appObservableObj.DsdPcmFreq = settings.dsdPcmFreq.ToString();
                ...
                _appObservableObj.CoverSize = settings.CoverSize;
                _appObservableObj.EntranceAnimationTime = settings.EntranceAnimationTime;
                _appObservableObj.SlideAnimationTime = settings.SlideAnimationTime;
                _appObservableObj.DrillInAnimationTime = settings.DrillInAnimationTime;
                _appObservableObj.IsBackgroundCoverEnabled = settings.IsBackgroundCoverEnabled;
                _appObservableObj.IsFolderWatchEnabled = settings.IsFolderWatchEnabled;
                _appObservableObj.IsCustomAppSize = settings.IsCustomAppSize;
                _appObservableObj.AppWidth = settings.AppWidth;
                _appObservableObj.AppHeight = settings.AppHeight;
                _appObservableObj.FontFamilyList = new System.Collections.ObjectModel.ObservableCollection<FontInfo>(GetSystemFontsInternal());
                _appObservableObj.FontFamily = _appObservableObj.FontFamilyList.AsValueEnumerable().FirstOrDefault(f => f.Name == GetCleanFontName(new Microsoft.UI.Xaml.Media.FontFamily(settings.GlobalFont).Source));
                _appObservableObj.CustomColor = Color.FromArgb(settings.CustomColorAlpha, settings.CustomColorRed, settings.CustomColorGreen, settings.CustomColorBlue);
                _appObservableObj.CustomOpacity = settings.CustomAcrylicOpacity * 100;
                _appObservableObj.IsUpdateBackDrop = settings.IsUpdateBackDrop;
                _appObservableObj.LyricsAlignment = settings.LyricsAlignment;
                _appObservableObj.LyricsMargin = new Thickness(settings.LyricsMargin, 0, settings.LyricsMargin, 0);
                _appObservableObj.GlobalFontSize = settings.GlobalFontSize;
                _appObservableObj.IsGlobalFontSizeEnabled = settings.IsGlobalFontSizeEnabled;
                _appObservableObj.MusicCoverCache = settings.MusicCoverCache;
                AppSettings.BassOutputDeviceId = settings.BassOutputDeviceId;
                _appObservableObj.IsDopEnabled = settings.IsDopEnabled;
                _appObservableObj.IsPlayDetailButtonVisible = settings.IsPlayDetailBtnVisible;
                _appObservableObj.IsFadeEnabled = settings.IsFadeEnabled;
                _appObservableObj.IsWFWLyrics = settings.IsWFWLyrics;
                _appObservableObj.LyricsBlurAmount = settings.LyricsBlurAmount * 10;
            }
        }
        ...
        private SaveSettings SaveCurrentSettings(SaveSettings newSettings,string equalizerStr = null) {            
            ...
            newSettings.Latency = _appObservableObj.Latency;
            newSettings.DeviceFriendlyName = AppSettings.DeviceName;
            newSettings.DefualtEntry = _appObservableObj.DefaultEntryComboBoxTag;
            newSettings.DefualtPlayList = _appObservableObj.DefaultPlayListComboBoxTag;
            //newSettings.LrcAPISource = _appObservableObj.LrcAPISource;
            //newSettings.LrcAPIAuth = _appObservableObj.LrcAPIAuth;
            newSettings.AppStyle = _appObservableObj.BackdropType;
            newSettings.AppTheme = _appObservableObj.ThemeType;
            newSettings.isCoverCacheEnabled = _appObservableObj.IsCoverCacheEnabled;
            newSettings.isRunningBackend = AppSettings.isRunningBackend;
            newSettings.isAutoLyricsEnabled = _appObservableObj.IsAutoLyricsEnabled;
            newSettings.dsdGain = _appObservableObj.DsdGain;
            ...
            newSettings.CoverSize = _appObservableObj.CoverSize;
            newSettings.DrillInAnimationTime = _appObservableObj.DrillInAnimationTime;
            newSettings.EntranceAnimationTime = _appObservableObj.EntranceAnimationTime;
            newSettings.SlideAnimationTime = _appObservableObj.SlideAnimationTime;
            newSettings.IsBackgroundCoverEnabled = _appObservableObj.IsBackgroundCoverEnabled;
            newSettings.IsFolderWatchEnabled = _appObservableObj.IsFolderWatchEnabled;
            newSettings.IsCustomAppSize = _appObservableObj.IsCustomAppSize;
            newSettings.AppHeight = _appObservableObj.AppHeight;
            newSettings.AppWidth = _appObservableObj.AppWidth;
            newSettings.GlobalFont = _appObservableObj.FontFamily.FontFamily.Source;
            newSettings.CustomAcrylicOpacity = _appObservableObj.CustomOpacity / 100;
            newSettings.CustomColorAlpha = _appObservableObj.CustomColor.A;
            newSettings.CustomColorRed = _appObservableObj.CustomColor.R;
            newSettings.CustomColorGreen = _appObservableObj.CustomColor.G;
            newSettings.CustomColorBlue = _appObservableObj.CustomColor.B;
            newSettings.IsUpdateBackDrop = _appObservableObj.IsUpdateBackDrop;
            newSettings.LyricsAlignment = _appObservableObj.LyricsAlignment;
            newSettings.LyricsMargin = (int)_appObservableObj.LyricsMargin.Left;
            newSettings.GlobalFontSize = _appObservableObj.GlobalFontSize;
            newSettings.IsGlobalFontSizeEnabled = _appObservableObj.IsGlobalFontSizeEnabled;
            newSettings.MusicCoverCache = _appObservableObj.MusicCoverCache;
            newSettings.BassOutputDeviceId = AppSettings.BassOutputDeviceId;
            newSettings.IsDopEnabled = _appObservableObj.IsDopEnabled;
            newSettings.dsdPcmFreq = int.Parse(_appObservableObj.DsdPcmFreq);
            newSettings.IsPlayDetailBtnVisible = _appObservableObj.IsPlayDetailButtonVisible;
            newSettings.IsFadeEnabled = _appObservableObj.IsFadeEnabled;
            newSettings.IsWFWLyrics = _appObservableObj.IsWFWLyrics;
            newSettings.LyricsBlurAmount = _appObservableObj.LyricsBlurAmount;
            return newSettings;
        }
